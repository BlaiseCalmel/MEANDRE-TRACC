...
```sh
sudo mkdir -p /var/www/MEANDRE-TRACC/access_log/hash_access_log
```
...
```sh
00 7 * * * root /usr/bin/Rscript $SERVER_DIR/MEANDRE-TRACC/access_log/script_hash_access_log.R >> /var/log/MEANDRE-TRACC_script_hash.log 2>&1
```
